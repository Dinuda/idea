...
ALTER TABLE `projectstudentteam` ADD FOREIGN KEY (`project_id`) REFERENCES `projects` (`studentteam`);

ALTER TABLE `projectinvestorteam` ADD FOREIGN KEY (`project_id`) REFERENCES `projects` (`investorteam`);
